export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'Data for trello-react-app',
    ...
    columns: [
        ...
        cards: [
          {
            ...
            cover: 'https://images01.nicepagecdn.com/page/10/56/website-template-preview-1056330.jpg',
      ...
      },
      {
        ...
        cardOrderIds: ['card-id-08', 'card-id-09', 'card-id-10', 'card-id-14', 'card-id-15', 'card-id-16'],
        cards: [
          ...
          { _id: 'card-id-14', boardId: 'board-id-01', columnId: 'column-id-02', title: 'Title of card 14', description: null, cover: null, memberIds: [], comments: [], attachments: [] },
          { _id: 'card-id-15', boardId: 'board-id-01', columnId: 'column-id-02', title: 'Title of card 15', description: null, cover: null, memberIds: [], comments: [], attachments: [] },
          { _id: 'card-id-16', boardId: 'board-id-01', columnId: 'column-id-02', title: 'Title of card 16', description: null, cover: null, memberIds: [], comments: [], attachments: [] }
        ]
      },
      {
        _id: 'column-id-03',
